 ...
 * return the same underlying recorder. Callers are encouraged to cache the returned instrument, but
 * a correct implementation must tolerate repeated creation.</li>
 * </ul>
 *
