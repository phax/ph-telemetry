 ...
 */
final class OtelTelemetrySpan implements ITelemetrySpan
{
  private final Span m_aSpan;
  private final Scope m_aScope;
  private boolean m_bClosed;

  OtelTelemetrySpan (@NonNull final Span aSpan)
  {
    m_aSpan = aSpan;
  ...
  public ITelemetrySpan addEvent (@NonNull final String sName, @NonNull final TelemetryAttributes aAttributes)
  {
    if (aAttributes.isEmpty ())
      ...
      m_aSpan.addEvent (sName, OtelAttributesConverter.toOtelAttributes (aAttributes));
    return this;
  }
